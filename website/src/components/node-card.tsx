  ...
  return (
    <div className={`${styles.nodeDetails}`}>
      ...
      <div className={styles.nodeDetailsLine}>
        ...
        <div className={styles.nodeDetailsData}>
          {props.peerId?.length > 0 ? props.peerId : "loading..."}
        </div>
      ...
      {props.apiEndpoint && (
        <div className={styles.nodeDetailsLine}>
          ...
          <div className={styles.nodeDetailsData}>{props.apiEndpoint}</div>
          <div className={styles.nodeDetailsCopy}>
      ...
      {props.apiToken && (
        <div className={styles.nodeDetailsLine}>
          ...
          <div className={styles.nodeDetailsData}>{props.apiToken}</div>
          <div className={styles.nodeDetailsCopy}>
