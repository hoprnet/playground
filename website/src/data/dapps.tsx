...
export const dapps:Apps = [
    {
        ...
        text:
            <div>
                Developer: <a href="https://github.com/hoprnet" target="_blank" rel="noreferrer">https://github.com/hoprnet</a>
                <br/><br/>
                ...
                <br/><br/>
                Type &apos;help&apos; for a list of available commands, or visit our docs at docs.hoprnet.org for more information.
            </div>
    },
    {
        key: 'hopr-visual',
        ...
        text:
            <div>
                Developer: <a href="https://github.com/Eliaxie" target="_blank" rel="noreferrer">https://github.com/Eliaxie</a>
                <br/><br/>
                Visualizer draws a graphical representation of the HOPR network, showing all the nodes and the connections between them.
                <br/><br/>
                Use the interface to toggle between two modes: the first uses subgraph data to visualize payment channels, the second by getting information from the nodes themselves.
            </div>,
    },
    {
        ...
        text:
            <div>
                Developer: <a href="https://github.com/0xMrH" target="_blank" rel="noreferrer">https://github.com/0xMrH</a>
                <br/><br/>
    ...
    },
    {
        ...
        text:
            <div>
                Developer: <a href="https://github.com/0xjjpa" target="_blank" rel="noreferrer">https://github.com/0xjjpa</a>
                <br/><br/>
                A proof of concept dApp to demonstrate multihop messages. Send a message from a node, which will boomerang back to the sender after passing through the HOPR network.
                <br/><br/>
                Learn how to build this dApp and what’s going on under the hood by following the step-by-step tutorial in our docs: <a href="https://docs.hoprnet.org/developers/demo-boomerang-chat" target="_blank" rel="noreferrer">https://docs.hoprnet.org/developers/demo-boomerang-chat</a>
            </div>,
    },
    {
        key: 'hopr-chess',
